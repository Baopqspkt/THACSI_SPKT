clear;
clc;
%A=imread('lenna_left.png');% read Picture 1 A represents the pixel array of Picture 1
%B=imread('lenna_right.png');% read Picture 2

A=imread('left1.jpg');% read Picture 1 A represents the pixel array of Picture 1
B=imread('right1.jpg');% read Picture 2
[x1,y1]=size(A(:,:,1));
